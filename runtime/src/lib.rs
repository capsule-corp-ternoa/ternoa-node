...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        DdayProtocol: ternoa_dday_protocol = 107,
    }
);
...
impl_runtime_apis! {
    ...
    impl frame_benchmarking::Benchmark<Block> for Runtime {
        fn benchmark_metadata(extra: bool) -> (
            ...
            list_benchmark!(list, extra, ternoa_dday_protocol, DdayProtocol);
        ...
        fn dispatch_benchmark(
            ...
            add_benchmark!(params, batches, ternoa_dday_protocol, DdayProtocol);
