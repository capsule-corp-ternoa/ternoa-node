...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark_with_event(b: u32, ) -> Weight {
		Weight::from_ref_time(63_535_000 as u64)
			// Standard Error: 0
	...
	fn set_storage(i: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(648_000 as u64).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(512_000 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(1_058_000 as u64).saturating_mul(p as u64))
