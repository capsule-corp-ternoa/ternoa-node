...
impl<T: frame_system::Config> pallet_im_online::WeightInfo for WeightInfo<T> {
	...
	fn validate_unsigned_and_then_heartbeat(k: u32, e: u32, ) -> Weight {
		Weight::from_ref_time(92_456_000 as u64)
			// Standard Error: 7_000
			.saturating_add(Weight::from_ref_time(29_000 as u64).saturating_mul(k as u64))
			// Standard Error: 75_000
			.saturating_add(Weight::from_ref_time(410_000 as u64).saturating_mul(e as u64))
