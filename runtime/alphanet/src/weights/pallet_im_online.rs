...
impl<T: frame_system::Config> pallet_im_online::WeightInfo for WeightInfo<T> {
	...
	fn validate_unsigned_and_then_heartbeat(_k: u32, e: u32, ) -> Weight {
		Weight::from_ref_time(128_900_000 as u64)
			// Standard Error: 70_354
			.saturating_add(Weight::from_ref_time(410_324 as u64).saturating_mul(e as u64))
