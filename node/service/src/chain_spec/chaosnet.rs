...
use chaosnet_runtime::{
	...
	ImOnlineConfig, NftsConfig, SessionConfig, SessionKeys, StakingConfig, SudoConfig,
	...
	GenesisConfig {
		...
		staking: StakingConfig {
			...
			stakers: initial_authorities
				.iter()
				.map(|x| {
					(x.0.clone(), x.1.clone(), STASH, chaosnet_runtime::StakerStatus::Validator)
				})
				.collect(),
		...
		associated_accounts: AssociatedAccountsConfig { ..Default::default() },
...
//     BalancesConfig, Block, GenesisConfig, GrandpaConfig, ImOnlineConfig, NftsConfig,
