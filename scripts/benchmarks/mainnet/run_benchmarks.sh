...
COMMAND="./target/release/ternoa benchmark --chain mainnet-dev --steps=50 --repeat=20 --extrinsic=* --execution=wasm --wasm-execution=compiled --heap-pages=4096 --output=./weights/"
MEDIUM_COMMAND="./target/release/ternoa benchmark --chain mainnet-dev --steps=10 --repeat=5 --extrinsic=* --execution=wasm --wasm-execution=compiled --heap-pages=4096 --output=./weights/"
SHORT_COMMAND="./target/release/ternoa benchmark --chain mainnet-dev --steps=5 --repeat=2 --extrinsic=* --execution=wasm --wasm-execution=compiled --heap-pages=4096 --output=./weights/"
